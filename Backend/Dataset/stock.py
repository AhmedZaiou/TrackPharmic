...
class Stock:
    ...
    def create_table_stock(conn):
        try:
            ...
            print(f"Erreur lors de la création de la table Stock: {e}")
    ...
    def ajouter_stock(
        ...
        try:
            ...
            print(f"Erreur lors de l'ajout du stock: {e}")
    ...
    def supprimer_stock(conn, id_stock):
        try:
            ...
            print(f"Erreur lors de la suppression du stock: {e}")
    ...
    def effectuer_vente_stock(conn, id_stock, quantite_vendu):
        try:
            ...
            print(f"Erreur lors de la vente du stock: {e}")
    ...
    def extraire_medicament_id_stock(conn, id_medicament):
        try:
            ...
            print(f"Erreur lors de l'extraction du stock par id_medicament: {e}")
            return None
    @staticmethod
    def extraire_stock(conn, id_stock):
        try:
            ...
            print(f"Erreur lors de l'extraction du stock par id_stock: {e}")
            return None
    ...
    def extraire_tous_stock(conn):
        try:
            ...
            print(f"Erreur lors de l'extraction de tous les stocks: {e}")
            return []
    ...
    def extraire_tous_medicament_with_expiration_date_minim(conn):
        try:
            ...
            print(f"Erreur lors de l'extraction des médicaments avec date d'expiration minimale: {e}")
            return []
    ...
    def extraire_stock_medicament(conn, alphabet='A'):
        try:
            ...
            print(f"Erreur lors de l'extraction des médicaments en stock: {e}")
            return []
    ...
    def extraire_medicament_quantite_minimale_sup_0(conn):
        try:
            ...
            print(f"Erreur lors de l'extraction des médicaments avec quantité minimale supérieure à 0: {e}")
            return []
    ...
    def get_situation_stock(conn):
        try:
            ...
            print(f"Erreur lors de l'extraction de la situation du stock: {e}")
            return {}
    ...
    def get_medicament_commande(conn, id_commande):
        try:
            ...
            cursor = conn.cursor(pymysql.cursors.DictCursor)
            cursor.execute(
                "SELECT m.Code_EAN_13, m.Nom,s.quantite_actuelle FROM Stock s JOIN  Medicament m  ON s.id_medicament = m.id_medicament where id_commande = %s",
                (id_commande,),
            )
            result = cursor.fetchall()
            ...
            print(f"Erreur lors de l'extraction des médicaments par commande: {e}")
            return []
    ...
    def calculer_total_achat_vente(conn):
        try:
            ...
            print(f"Erreur lors du calcul du total des achats et ventes: {e}")
            return 0, 0
    ...
    def cloture_journee(conn):
        try:
            ...
            return {
                ...
                or 0,
                "Nombre Médicaments proches de la date dexpiration aujourdhui": medicaments_proches_expiration
                or 0,
            }
        except Exception as e:
